                        ...
                        <div class="p-4">
                            <a href="#" aria-label="B2B action" target="_blank">
                                <NuxtImg style="width: 120px; height: 28px; border-radius: 40px;"
                                    src="/images/b2b_161ba831bf784bd3b60d4787af503cb2.avif" loading="lazy"
...
.main-header .header-wrap-action .header-action .header-action-item .header-action-text .box-icon svg.svg-ico-account {
    width: 22px;
    height: 40px;
}

.main-header .header-wrap-action .header-action .header-action-item .header-action-text .box-icon svg.svg-ico-cart {
    width: 22px;
    height: 40px;
}
