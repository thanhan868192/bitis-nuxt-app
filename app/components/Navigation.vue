...
<template>
    <div>
        <header id="main-header" class="main-header w-full fixed top-10 left-0 z-[1000]">
...
.main-header .header-wrap-menu ul.menuList-primary>li {
...
.main-header .header-wrap-menu ul.menuList-primary li.has-submenu .menuList-submain {
    background: #fff;
    min-width: 240px;
    max-width: 180%;
    position: absolute;
...
.main-header .header-wrap-menu ul.menuList-primary li.has-submenu:hover>.menuList-submain {
    pointer-events: auto;
    visibility: visible;
    top: 200%;
    opacity: 1;
...
.main-header .header-wrap-menu ul.menuList-submain li:not(:first-child) {
    border-top: 1px solid #ecf0f1;
}

.main-header .header-wrap-menu ul.menuList-submain li {
    padding: 9px 18px;
    text-align: left;
    display: block;
    font-size: 14px;
...
.main-header .header-wrap-menu ul.menuList-primary>li>i {
    display: inline-block;
...
.main-header .header-wrap-menu ul.menuList-primary>li:hover>i {
    opacity: 1;
